...
public class World {
	...
	public String[] getEntityInfo(){
		...
		for(int i=0; i<info.length; i++){
			...
			info[i] = "e "+e.getName()+" "+e.position.x+" "+e.position.y+" "+e.position.z+" "+e.getRotX()+" "+e.getRotY()+" "+e.getRotZ()+" "+e.getScale()+" "+b.pos.x+" "+b.pos.y+" "+b.pos.z+" "+b.size.x+" "+b.size.y+" "+b.size.z+" "+e.getIsStatic();
		}
